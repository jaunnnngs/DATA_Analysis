...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalSlider_3.valueChanged['int'].connect(self.shade_value)
        self.verticalSlider_4.valueChanged['int'].connect(self.gammer_value)
        ...
        self.shade_value_now = 0
        self.gammer_value_now = 0
    ...
    def shade_value(self, value):
        """ This function will take value from the slider
            for the brightness from 0 to 99
        """
        self.shade_value_now = value
        print('Shade: ', value)
        self.update()
...
import numpy as np
    ...
    def changeShade(p, num):
        img = p.copy()
        img = img.astype('int64')
        img = np.clip(img*num, 0, 255)
    ...
    def update(self):
        ...
        img = self.changeRotation(self.image, self.rotation_value_now)
        img = self.changeGammer(self.image, self.gammer_value_now)
        self.setPhoto(img)
