...
albumentations_dataset = AlbumentationsDataset(
    file_path=[f'./shark/shark_{i}.png' for i in range(0, len(os.listdir('./shark')))],
    transform=albumentations_transform
)

os.makedirs('./shark_transform', exist_ok=True)
total_time = 0
for i in range(0, len(os.listdir('./shark'))):
    sample, _, transform_time = albumentations_dataset[i]
    new_image = transforms.ToPILImage()(sample)
    new_image.save(f'./shark_transform/new_shark_{i}.png')
